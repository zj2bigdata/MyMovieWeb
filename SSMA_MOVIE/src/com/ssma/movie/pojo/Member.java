...
public class Member {
	...
	public String toString() {
		return "Member [member_Id=" + member_Id + ", member_Email=" + member_Email + ", member_Pwd=" + member_Pwd
				+ ", member_Name=" + member_Name + ", member_Phone=" + member_Phone + ", member_Money=" + member_Money
				+ ", member_Gender=" + member_Gender + ", member_Photo=" + member_Photo + "]";
	}
